...
public class ViewArticle extends Activity {
    ...
    public void shareOnFacebook() {
        trackSocialSharing(getString(R.string.facebook_share_category_id));
    ...
    public void shareOnTwitter() throws MalformedURLException {
        trackSocialSharing(getString(R.string.twitter_share_category_id));
    ...
    public void shareEmail() {
        trackSocialSharing(getString(R.string.email_share_category_id));
    ...
    public void shareOther() {
        trackSocialSharing(getString(R.string.other_share_category_id));
